...
public class ItemUpgradeMark4Compressor extends Item{

	private String name="";
	
	public ItemUpgradeMark4Compressor()
	{
		if (name.equals(""))
		{
			// do nothing
	...
	public ItemUpgradeMark4Compressor(String uname)
	{
		super();
			...
			if (playerIn.isSneaking())
			{
				...
				if (t!=null)
				{
					if ((TileEntityBarrel)t instanceof TileEntityBarrel)
					{
						...
						if (t2.itemHandler.size==32768)
						{
							t2.itemHandler.size = 65536;
							stack.stackSize-=1;
